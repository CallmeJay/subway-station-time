...
"NextTrain · Beijing Metro Helper" (`bjsubway-mini`) is an open-source MVP tool by an individual developer. This project has **no affiliation, authorization, partnership, or sponsorship** with Beijing Subway Operation Co., MTR Beijing Co., or any Beijing metro operator. This is an unofficial third-party tool.
